...
public class SocialAuthorizationRequest extends AsyncTask<String, String, CookieStore> {
    private OnAuthorizationTaskCompleted callback;
    private CookieStore mCookieStore;
    private String mToken;

    public SocialAuthorizationRequest(OnAuthorizationTaskCompleted callback, String token) {
